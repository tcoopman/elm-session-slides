...
Elm.Main.make = function (_elm) {
   ...
   $Text = Elm.Text.make(_elm);
   var _op = {};
   var fold = F3(function (func,b,tree) {
      var _p0 = tree;
      if (_p0.ctor === "Empty") {
            return b;
         } else {
            var fold$ = F3(function (func$,b$,tree$) {    return A3(fold,func$,tree$,b$);});
            return A3(fold$,func,_p0._2,A3(fold$,func,_p0._1,A2(func,_p0._0,b)));
         }
   });
   var foldr = F3(function (func,b,tree) {
      var _p1 = tree;
      if (_p1.ctor === "Empty") {
            return b;
         } else {
            var fold$ = F3(function (func$,b$,tree$) {    return A3(fold,func$,tree$,b$);});
            return A3(fold$,func,_p1._1,A3(fold$,func,_p1._2,A2(func,_p1._0,b)));
         }
   });
   var isElementFold = function (e) {    return A2(fold,F2(function (v,b) {    return b || _U.eq(v,e);}),false);};
   var isElement = F2(function (a,tree) {
      var _p2 = tree;
      if (_p2.ctor === "Empty") {
            return false;
         } else {
            return _U.eq(_p2._0,a) ? true : A2(isElement,a,_p2._1) || A2(isElement,a,_p2._2);
         }
   });
   var flattenFold = A2(fold,F2(function (x,y) {    return A2($List._op["::"],x,y);}),_U.list([]));
   var flatten = function (tree) {
      var _p3 = tree;
      if (_p3.ctor === "Empty") {
            return _U.list([]);
         } else {
            return A2($Basics._op["++"],_U.list([_p3._0]),A2($Basics._op["++"],flatten(_p3._1),flatten(_p3._2)));
         }
   };
   var sumFold = A2(fold,F2(function (x,y) {    return x + y;}),0);
   var sum = function (tree) {    var _p4 = tree;if (_p4.ctor === "Empty") {    return 0;} else {    return _p4._0 + sum(_p4._1) + sum(_p4._2);}};
   ...
   var depth = function (tree) {
      ...
      if (_p5.ctor === "Empty") {
            ...
            return 1 + A2($Basics.max,depth(_p5._1),depth(_p5._2));
         }
   };
   ...
   var insert = F2(function (x,tree) {
      ...
      if (_p6.ctor === "Empty") {
            ...
            var _p8 = _p6._2;
            var _p7 = _p6._1;
            return _U.cmp(x,_p9) > 0 ? A3(Node,_p9,_p7,A2(insert,x,_p8)) : _U.cmp(x,_p9) < 0 ? A3(Node,_p9,A2(insert,x,_p7),_p8) : tree;
         }
   });
   ...
   var map = F2(function (f,tree) {
      ...
      if (_p10.ctor === "Empty") {
            ...
            return A3(Node,f(_p10._0),A2(map,f,_p10._1),A2(map,f,_p10._2));
         }
   });
   var mapFold = function (f) {    return A2(foldr,F2(function (v,b) {    return A3(Node,f(v),b,Empty);}),Empty);};
   ...
   _U.list([A3(display,"depth",depth,t1)
           ...
           ,A3(display,"mapFold ((+)1)",mapFold(F2(function (x,y) {    return x + y;})(1)),t2)
           ,A3(display,"sum",sum,t1)
           ,A3(display,"sumFold",sumFold,t1)
           ,A3(display,"flatten",flatten,t1)
           ,A3(display,"flatten",flatten,t2)
           ,A3(display,"flattenFold",flattenFold,t1)
           ,A3(display,"flattenFold",flattenFold,t2)
           ,A3(display,"isElement 1",isElement(1),t1)
           ,A3(display,"isElement 0",isElement(0),t1)
           ,A3(display,"isElementFold 1",isElementFold(1),t1)
           ,A3(display,"isElementFold 0",isElementFold(0),t1)]));
